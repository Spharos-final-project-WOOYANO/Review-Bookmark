...
import spharos.review_bookmark.review.vo.response.ReviewListResponse;
...
public class ReviewController {
    ...
    public BaseResponse<List<ReviewListResponse>> retrieveReviewListController(@RequestParam("serviceId") Long serviceId){
        // 리뷰 리스트 조회
        List<ReviewListResponse> responseList = reviewService.retrieveReviewList(serviceId).stream()
                .map(dto -> ReviewListResponse.builder()
